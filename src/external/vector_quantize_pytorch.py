...
from torch import Tensor, einsum, is_tensor, nn, tensor
...
class Codebook(Module):
    ...
    def update_ema_indices(
        self, x, embed_ind, mask=None, ema_update_weight: Tensor | Callable | None = None, accum_ema_update=False
    ):
        ...
        self.update_ema_part(
            flatten, embed_onehot, mask=mask, ema_update_weight=ema_update_weight, accum_ema_update=accum_ema_update
        )
